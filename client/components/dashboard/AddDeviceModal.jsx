        ...
        <div className="mt-8 flex w-full flex-col gap-5 self-stretch">
          ...
          <Field label="Group">
            <div className="relative">
              <select
                className="h-[55px] w-full appearance-none rounded-[8px] border border-[#D0D5DD] bg-white px-[14px] py-[10px] pr-[44px] text-[16px] font-normal leading-6 text-[#667085] shadow-[0_1px_2px_rgba(16,24,40,0.05)] focus:outline-none focus:ring-2 focus:ring-[#2970FF]/25"
                style={{ fontFamily: "Inter, sans-serif", fontStyle: "normal" }}
              ...
              <span className="pointer-events-none absolute inset-y-0 right-[14px] flex items-center">
                <ChevronDownIcon />
              </span>
            </div>
          </Field>
